...
<template>
  ...
  <Teleport to="#teleport-target-ui-left">
    <div class="badge cursor-pointer" :class="laserActive ? 'badge-success' : ''" @click="toggleLaser"
      title="Click or press L to toggle laser pointer">
      Laser pointer is {{ laserActive ? 'on' : 'off' }}
    </div>
  </Teleport>
</template>
