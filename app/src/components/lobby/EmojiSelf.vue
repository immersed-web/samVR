...
<template>
  <a-entity ref="emoji" position="0 1.2 -1"
    animation__show="property: position; to: 0 0.6 -1; dur: 1000; easing: easeOutQuad; startEvents: show"
    animation__hide="property: position; to: 0 1.2 -1; dur: 1000; easing: easeInQuad; startEvents: hide">
