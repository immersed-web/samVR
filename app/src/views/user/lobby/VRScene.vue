...
onBeforeMount(async () => {
  ...
  await c.registerAframeComponents();
  ...
  >
    ...
    <template v-if="!oculusHandSimulator.simulate">
      <a-entity
        ...
        @xbuttondown="oculusButtons['x'] = true"
        @xbuttonup="oculusButtons['x'] = false"
        @ybuttondown="oculusButtons['y'] = true"
        @ybuttonup="oculusButtons['y'] = false"
      />
      <a-entity
        id="tp-aframe-hand-right"
        oculus-touch-controls="hand: right"
        @abuttondown="oculusButtons['a'] = true"
        @abuttonup="oculusButtons['a'] = false"
        @bbuttondown="oculusButtons['b'] = true"
    ...
    <a-entity position="10 0 -3">
      ...
      <!-- Emoji entity -->
      <EmojiOther
        :sheet-url="emojiSheetUrl"
        :coords="emojiCoordsOther"
        :active="emojiActiveOther"
      />
    </a-entity>
