...
export default function () {
  ...
  AFRAME.registerComponent('camera-controls', {
    ...
    controls: undefined as CameraControls | undefined,
    ...
    init: function () {
      ...
      el.getObject3D('camera').position.set(0, 1, 1);
    },
    ...
    play: function () {
      ...
      const cam = el.sceneEl!.camera as THREE.PerspectiveCamera
      // const w = el.sceneEl!.canvas.width
      // const h = el.sceneEl!.canvas.height
      ...
      // this.controls.setFocalOffset(-0.3, 0, 0)
